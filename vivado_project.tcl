...
#
# Generated by Vivado on Sun Jun 29 23:50:25 +0200 2025
...
#
#    "C:/Users/Irene/Documents/VivadoProjects/TFM/TFM/irene_darkriscv/vivado_project/vivado_project.srcs/sources_1/new/register.v"
...
#    "C:/Users/Irene/Documents/VivadoProjects/TFM/TFM/irene_darkriscv/rtl/i2c/i2c_test_bench.v"
#    "C:/Users/Irene/Documents/VivadoProjects/TFM/TFM/irene_darkriscv/rtl/common/peripherals.vh"
...
set files [list \
 [file normalize "${origin_dir}/rtl/common/7sdisplay_driver.v"] \
 [file normalize "${origin_dir}/rtl/pwm/PWM_module.v"] \
 [file normalize "${origin_dir}/rtl/spi/SPI_Master.v"] \
 [file normalize "${origin_dir}/rtl/spi/SPI_Master_With_Single_CS.v"] \
 [file normalize "${origin_dir}/rtl/config.vh"] \
 [file normalize "${origin_dir}/rtl/darkpll.v"] \
 [file normalize "${origin_dir}/rtl/darkriscv.v"] \
 [file normalize "${origin_dir}/rtl/darkuart.v"] \
 [file normalize "${origin_dir}/rtl/common/display_driver_n4.v"] \
 [file normalize "${origin_dir}/rtl/common/flag_register.v"] \
 [file normalize "${origin_dir}/rtl/i2c/i2c_master.v"] \
 [file normalize "${origin_dir}/rtl/common/synchronizer.v"] \
 [file normalize "${origin_dir}/rtl/darksocv.v"] \
 [file normalize "${origin_dir}/rtl/darkcache.v"] \
 [file normalize "${origin_dir}/rtl/i2c/i2c_test_bench.v"] \
 [file normalize "${origin_dir}/rtl/common/peripherals.vh"] \
]
add_files -norecurse -fileset $obj $files

# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/vivado_project/vivado_project.srcs/sources_1/new/register.v" ]\
]
set added_files [add_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/rtl/config.vh"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj

set file "$origin_dir/rtl/common/peripherals.vh"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog Header" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "darksocv" -objects $obj
...
set file "[file normalize "$origin_dir/boards/digilent_basys3_a35/Basys3_GPIO.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/boards/digilent_basys3_a35/Basys3_GPIO.xdc"
set file [file normalize $file]
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/boards/digilent_basys3_a35/Basys3_GPIO.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7a35tcpg236-1" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/boards/digilent_basys3_a35/Basys3_GPIO.xdc"]" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/sim/darksimv.v"] \
 [file normalize "${origin_dir}/sim/SPI_Master_With_Single_CS_TB.sv"] \
 [file normalize "${origin_dir}/sim/I2Csim.v"] \
 [file normalize "${origin_dir}/src/darksocv.mem"] \
 [file normalize "${origin_dir}/src/darksocv.rom.mem"] \
...
set file "$origin_dir/src/darksocv.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj

set file "$origin_dir/src/darksocv.rom.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj

set file "$origin_dir/src/darksocv.ram.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj
...
set_property -name "top" -value "darksimv" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
